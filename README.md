...
*   **Методы:**
    *   `render( ICatalogCard): HTMLElement` - отрисовывает карточку каталога с переданными данными.
...
*   **Сеттеры:**
    *   `index(value: number)`
*   **Методы:**
    *   `render( IBasketCard): HTMLElement` - отрисовывает карточку корзины с переданными данными.
...
*   **Методы:**
    ...
    *   `render( IModalData): HTMLElement` - вызывает `openModal` с переданным содержимым.
...
*   **Методы:**
    *   `render( IBasketData): HTMLElement` - отрисовывает корзину с переданными данными.
...
*   **Методы:**
    *   `render( IOrderFormState): HTMLElement` - отрисовывает форму с переданными данными.
...
*   **Методы:**
    *   `render( IContactFormState): HTMLElement` - отрисовывает форму с переданными данными.
...
*   **Методы:**
    *   `render( ISuccessData): HTMLElement` - отрисовывает окно успеха с переданными данными.
